...
// Envelope comum a qualquer evento publicado por este servico (docs/API-CONTRACTS.md) -
// correlationId fica de fora ate existir X-Correlation-Id de verdade (api-gateway, epic-008).
